...
tmp = np.loadtxt("data1.csv",dtype=np.str,delimiter=',')
# train_data = tmp[4001:14001,0:54].astype(np.float)#加载数据部分
# train_label = tmp[4001:14001,54].astype(np.float)#加载类别标签部分
train_data = tmp[1:8001,0:5].astype(np.float)#加载数据部分
train_label = tmp[1:8001,5].astype(np.float)#加载类别标签部分


#分别加载测试数据集 五个分类 每一类500行数据
test_data_class3 = tmp[8001:8501,0:5].astype(np.float)#加载数据部分
test_label_class3 = tmp[8001:8501,5].astype(np.float)#加载类别标签部分

test_data_class4 = tmp[8501:9001,0:5].astype(np.float)#加载数据部分
test_label_class4 = tmp[8501:9001,5].astype(np.float)#加载类别标签部分

test_data_class5 = tmp[9001:9501,0:5].astype(np.float)#加载数据部分
test_label_class5 = tmp[9001:9501,5].astype(np.float)#加载类别标签部分

test_data_class6 = tmp[9501:10001,0:5].astype(np.float)#加载数据部分
test_label_class6 = tmp[9501:10001,5].astype(np.float)#加载类别标签部分
